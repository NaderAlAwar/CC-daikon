...
def getTests(project, version, attribute): # attribute can be strong or weak
	csvFile = "/home/nader/Projects/499/Oracles/" + project
	if attribute == "strong":
...
def getTestCases(testClass, version):
	with open("/home/nader/Projects/499/" + project + "/v" + str(version) + "/daikon-all-tests.txt") as file: # read all the tests
...
for i in range(1,versionRange):
	...
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/all-tests.txt") as file:
		content = file.readlines()
	content = [x.strip() for x in content] 
	content = [x.split('(')[1][:-1] + '::' + x.split('(')[0] for x in content]
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/daikon-all-tests.txt",'w') as outFile:
		for line in content:
			outFile.write(line + '\n')
	...
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/strong.txt",'w') as outFile: # write strong cc
		for line in strong:
			outFile.write(line + '\n')

	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/weak.txt",'w') as outFile: # write weak cc
		for line in weak:
			outFile.write(line + '\n')

	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/daikon-all-tests.txt") as file: # read all the tests
		allTests = file.read().splitlines()

	allTests = set(allTests) # remove duplicates

	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/fail.txt") as file: # read failing tests (generated by a bash script)
	...
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/pass.txt",'w') as outFile: # write passing tests
		for line in passingTests:
			outFile.write(line + '\n')

	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/all-tests.txt") as file: # read all the tests
		allTests = file.read().splitlines()
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/strong.txt") as file: # read all the tests
		strongTests = file.read().splitlines()
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/weak.txt") as file: # read all the tests
		weakTests = file.read().splitlines()
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/fail.txt") as file: # read all the tests
	...
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/pass.txt",'w') as outFile: # write strong cc
	...
	with open("/home/nader/Projects/499/" + project + "/v" + str(i) + "/pass.txt",'a') as outFile: # write passing tests
